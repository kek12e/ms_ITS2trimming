...
##		./v20240723__standard.NOtrimm_DADA2_ITS.R > v20240723__standard.NOtrimm_DADA2_ITS.R.out 2>&1
##		conda deactivate
...
fqpath.filtN <- file.path("./filtN")
fnFs.filtN <- file.path(fqpath.filtN, gsub("\\.fastq\\.gz$","_filtN.fastq.gz",basename(fnFs))) 
fnRs.filtN <- file.path(fqpath.filtN, gsub("\\.fastq\\.gz$","_filtN.fastq.gz",basename(fnRs))) 
